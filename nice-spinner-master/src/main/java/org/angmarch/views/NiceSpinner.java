...
public class NiceSpinner extends TextView {
    ...
    private boolean arrowIsBlack = false;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (!isArrowHide) {
            Drawable basicDrawable = ContextCompat.getDrawable(context,arrowIsBlack?R.drawable.arrow:R.drawable.arrow_white);
...
//        popupWindow.setHeight(WindowManager.LayoutParams.WRAP_CONTENT);
    ...
    public boolean isArrowIsBlack() {
        return arrowIsBlack;
    }

    public void setArrowIsBlack(boolean arrowIsBlack) {
        this.arrowIsBlack = arrowIsBlack;
    }
}
